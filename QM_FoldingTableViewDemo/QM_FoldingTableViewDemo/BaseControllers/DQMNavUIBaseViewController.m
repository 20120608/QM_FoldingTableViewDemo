...
/**头部标题*/
- (NSMutableAttributedString*)lmjNavigationBarTitle:(DQMNavigationBar *)navigationBar {
...
/** 背景色 */
- (UIColor *)lmjNavigationBackgroundColor:(DQMNavigationBar *)navigationBar {
...
/** 导航条的高度 */
- (CGFloat)lmjNavigationHeight:(DQMNavigationBar *)navigationBar {
...
- (DQMNavigationBar *)lmj_navgationBar {
  // 父类控制器必须是导航控制器
